...
**Senior iOS Engineer · Swift · SwiftUI · Quality & Delivery at Scale**
...
| Focus | Highlights |
| ------ | ----------- |
| **Platform** | iOS / iPadOS, Xcode, Swift, SwiftUI, UIKit, Objective-C where legacy demands it |
| **Quality** | Unit testing, TDD-minded workflows, automation-friendly architecture |
| **Delivery** | CI/CD (e.g. Azure DevOps, pipelines, release cadence with QA & product) |
| **Leadership** | Guild lead experience, mentoring, architecture docs, onboarding acceleration |
| **Impact** | WCAG / Apple HIG-aligned UX, scalable patterns for large user bases |

---

## Technical expertise

Mobile is my core: **Xcode, Swift, SwiftUI**, and **Objective-C** for mature codebases. I have also delivered **Android** work with **Kotlin** and **Java** in **Android Studio** when products span both stores. Across roles I have aligned engineering practice with **automated testing**, **pipeline-based delivery**, and **accessible**, **consistent** UI.

---

## Contact

- **Email:** israelmanzo814@gmail.com
...
I owned the full lifecycle of a **SwiftUI** iOS/iPad enterprise app: REST integration, data modeling, offline caching, and reliability. I led adoption of **unit testing** and **TDD** practices and mentored the team on Swift, modular structure, and shipping on aggressive timelines without sacrificing quality.

### iOS Engineer · FlaveApp *(Lead iOS Developer)*

I maintained a hybrid **UIKit / SwiftUI** codebase with a strong focus on **accessibility**, stability, and fast turnaround on production issues during a high-growth phase.

### Full Stack Developer · Plate Rate

I built responsive web UI with **React**, HTML5, CSS3, and modern JavaScript, and collaborated with QA on **E2E testing** (Cypress, WebDriver) for safer releases.
...
Check it out on the [App Store](https://apps.apple.com/us/app/device-health/id6748570907).
...
Browse the repo: [Utils on GitHub](https://github.com/israman30/Utils).
...
<sub><strong>@israman30</strong> · iOS · Swift · SwiftUI</sub>
